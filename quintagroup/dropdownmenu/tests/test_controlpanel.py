...
class RegistryTest(TestCase):
    ...
    def test_show_content_tabs(self):
        ...
        show_content_tabs = self.registry.records[
             IPREFIX + 'show_content_tabs']
    ...
    def test_content_tabs_level(self):
        ...
        content_tabs_level = self.registry.records[
            IPREFIX + 'content_tabs_level']
    ...
    def test_show_actions_tabs(self):
        ...
        show_actions_tabs = self.registry.records[
            IPREFIX + 'show_actions_tabs']
    ...
    def test_actions_tabs_level(self):
        ...
        actions_tabs_level = self.registry.records[
            IPREFIX + 'actions_tabs_level']
